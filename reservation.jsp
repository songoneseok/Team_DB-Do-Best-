...
try {
	...
	String sql = 
			"select rs.Reservation_No, cs.Customer_ID, cs.Customer_Name, tr.travel_place  from reservation rs, customer cs, travel tr where tr.travel_place='해운대' AND RS.RESERVATION_NO='1000002'";
